...
<body style="background-color: #E4B89B">
    ...
    <div class="container" style="margin: auto;max-width: 340px;">
        ...
        <form role="form" style="margin-top: 60px;" method="post" action="${ctx}/trip-admin/insertUser">
            ...
            <br>
            <input name="question" class="form-control" type="text" style="font-size: 18px;height: 40px;"placeholder="密保问题"required>
            <br>
